...
Copyright (c) 2025 German Jablonski.
...
You may use, modify, and redistribute the Software for any purpose, including
commercial use, provided that none of the activities fall under the Prohibitions
defined below.
...
1. Distribute software that offers the same or substantially similar
   functionality as `@docukit/docsync`, including but not limited to libraries that
...
2. Offer any hosted or cloud-based service to third parties that provides the
   same or substantially similar functionality as `@docukit/docsync`, unless you
   have an explicit license from the copyright holder.

These restrictions do not prevent you from developing or using similar
functionality for your own internal or personal use.

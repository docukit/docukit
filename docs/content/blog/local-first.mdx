...
type: "article",
image: "7-ideals.png",
url: "https://docukit.dev/local-first",
article: {
...
Stay tuned for more announcements soon. To keep up with the latest updates, follow the project on [Discord](https://discord.gg/WWCWcphGSJ), [Twitter](https://x.com/docnode), or [GitHub](https://github.com/docukit/docukit).

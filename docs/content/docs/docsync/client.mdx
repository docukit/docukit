...
<TypeTable
  type={{
    local: {
      description: "A change made by this client in this document instance.",
      type: '"local"',
    },
    network: {
      description:
        "A change received from the DocSync server, usually from another device.",
      type: '"network"',
    },
    "local-broadcast": {
      description:
        "A change received through local broadcast from another tab or window on this device.",
